...
func show_home() -> void:
	...
	var nav_style := style(Color(0.05, 0.07, 0.14, 0.88), 14)
	nav_style.border_color = Color(0.12, 0.35, 0.60, 0.85)
...
func show_tutorial_class_picker(tutorial_lesson: int) -> void:
	...
	dialog.position = -dialog.size / 2.0 + Vector2(0,75)
	dialog.z_index = 901
...
func _show_battle_intro(player_class_name: String, opponent_class_name: String) -> void:
	...
	var left_border_top := ColorRect.new()
	left_border_top.color = pc
	left_border_top.position = Vector2(-700.0, 0.0)
	left_border_top.size = Vector2(660, 4)
	left_border_top.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(left_border_top)
	left_border_top.z_index = 100
	var left_border_bottom := ColorRect.new()
	left_border_bottom.color = pc
	left_border_bottom.position = Vector2(-700.0, 716.0)
	left_border_bottom.size = Vector2(660, 4)
	left_border_bottom.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(left_border_bottom)
	left_border_bottom.z_index = 100
	var left_border_side := ColorRect.new()
	left_border_side.color = pc
	left_border_side.position = Vector2(-700.0, 0.0)
	left_border_side.size = Vector2(4, 720)
	left_border_side.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(left_border_side)
	left_border_side.z_index = 100
	var left_border_right := ColorRect.new()
	left_border_right.color = pc
	left_border_right.position = Vector2(-44.0, 0.0)
	left_border_right.size = Vector2(4, 720)
	left_border_right.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(left_border_right)
	left_border_right.z_index = 100
	...
	var right_border_top := ColorRect.new()
	right_border_top.color = oc
	right_border_top.position = Vector2(1400.0, 0.0)
	right_border_top.size = Vector2(660, 4)
	right_border_top.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(right_border_top)
	right_border_top.z_index = 100
	var right_border_bottom := ColorRect.new()
	right_border_bottom.color = oc
	right_border_bottom.position = Vector2(1400.0, 716.0)
	right_border_bottom.size = Vector2(660, 4)
	right_border_bottom.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(right_border_bottom)
	right_border_bottom.z_index = 100
	var right_border_side := ColorRect.new()
	right_border_side.color = oc
	right_border_side.position = Vector2(2056.0, 0.0)
	right_border_side.size = Vector2(4, 720)
	right_border_side.mouse_filter = Control.MOUSE_FILTER_IGNORE
	intro.add_child(right_border_side)
	right_border_side.z_index = 100
	...
	tween.tween_property(left_art,  "position:x", 0.0,    0.65)
	tween.tween_property(left_border_top, "position:x", 0.0, 0.65)
	tween.tween_property(left_border_bottom, "position:x", 0.0, 0.65)
	tween.tween_property(left_border_side, "position:x", 0.0, 0.65)
	tween.tween_property(left_border_right, "position:x", 656.0, 0.65)
	tween.tween_property(left_art,  "modulate:a", 1.0,    0.28)
	tween.tween_property(right_art, "position:x", 620.0,  0.65)
	tween.tween_property(right_border_top, "position:x", 620.0, 0.65)
	tween.tween_property(right_border_bottom, "position:x", 620.0, 0.65)
	tween.tween_property(right_border_side, "position:x", 1276.0, 0.65)
	tween.tween_property(right_art, "modulate:a", 1.0,    0.28)
	tween.tween_property(vs, "scale", Vector2(1.35, 1.35), 0.50)
	tween.chain().tween_property(vs, "scale", Vector2.ONE, 0.16)
